/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7cd9c7d8deda1faa2ed3075c661e88b)
// Runtime types generated with workerd@1.20260828.1 2026-08-28
interface __BaseEnv_Env {
	MARKETING_BRIDGE_RATE_LIMITER: RateLimit;
	BRIDGE_ENABLED: "false";
	SITE_ORIGIN: "https://www.gipitorifotografias.com.br";
	CRM_INGEST_URL: string;
	MARKETING_SITE_KEY_ID: string;
	MARKETING_SITE_SIGNING_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BRIDGE_ENABLED" | "SITE_ORIGIN" | "CRM_INGEST_URL" | "MARKETING_SITE_KEY_ID" | "MARKETING_SITE_SIGNING_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}
