        ...
        <div className="mb-4">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:border-gray-400 dark:focus:border-gray-600"
            />
          </div>
        </div>
            ...
            <thead className="bg-gray-50 dark:bg-gray-800/80 sticky top-0">
              <tr>
                <th
                  ...
                  className="text-left px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors"
                >
                ...
                return (
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="font-medium text-gray-900 dark:text-white text-sm">{deal.title}</div>
                    </td>
                    <td className="px-4 py-3">
