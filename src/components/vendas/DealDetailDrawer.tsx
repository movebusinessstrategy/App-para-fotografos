      ...
      <div className="fixed inset-0 z-50 flex justify-end">
        ...
        <div className="p-4 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              {historyError && !loadingHistory && (
                <p className="text-xs text-red-500">Histórico não disponível</p>
              )}
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      />
                      {!isLast && (
                        <span className="flex-1 w-px bg-gray-200 mt-1 mb-1" />
                      )}
                    </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              <label className="text-xs font-medium text-gray-500 uppercase">Previsão</label>
            ...
            <div>
              ...
              <p className="text-sm text-gray-900 capitalize">{deal.priority || "Média"}</p>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4 space-y-2">
            <div className="flex gap-2">
              <button
                onClick={markAsWon}
                className="flex-1 flex items-center justify-center gap-2 py-2 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 text-sm font-medium"
              >
                <CheckCircle size={16} />
                Marcar como Ganho
              </button>
              <button
                onClick={markAsLost}
                className="flex-1 flex items-center justify-center gap-2 py-2 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 text-sm font-medium"
              >
                <XCircle size={16} />
                Marcar como Perdido
              </button>
            ...
            <button
              onClick={deleteDeal}
              className="w-full flex items-center justify-center gap-2 py-2 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-lg text-sm"
            >
              <Trash2 size={16} />
              Excluir Negócio
            </button>
