          ...
          <div className="space-y-8 text-sm leading-relaxed text-white/80">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 pl-2">
                ...
                <li><strong className="text-white">Dados da integração Google Ads:</strong> quando a integração estiver disponível, for autorizada pelo titular e a conta for vinculada pela equipe autorizada da plataforma, acessamos os identificadores das contas de administrador e anunciante autorizadas, campanhas e métricas agregadas como impressões, cliques, custo, conversões e valor de conversão. Também podemos armazenar identificadores de clique recebidos nos seus canais, como GCLID, GBRAID e WBRAID, para futuramente relacionar um lead ou uma venda do CRM à campanha de origem, somente após validação verificável.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 pl-2 mb-3">
                <li><strong className="text-white">Dados acessados:</strong> identificadores e nomes da conta e das campanhas; datas, status e métricas de desempenho, como impressões, cliques, custo, conversões e valor de conversão.</li>
