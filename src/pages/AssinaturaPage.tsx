...
import { AlertCircle, Check, Clock, CreditCard, QrCode, X } from "lucide-react";
        ...
        <div className="flex flex-wrap gap-2 mt-5 pt-5 border-t border-gray-100 dark:border-gray-700">
          ...
          {status === "past_due" && (
            <div className="flex items-center gap-2 text-sm text-amber-700 dark:text-amber-300">
              <AlertCircle size={16} />
              O último pagamento não foi confirmado. Atualize o método de pagamento ou aguarde o reprocessamento.
            </div>
          )}
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 max-w-md w-full shadow-xl">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-5">
              Você continuará tendo acesso até o final do período atual. Após isso, o acesso aos recursos pagos será bloqueado.
            </p>
